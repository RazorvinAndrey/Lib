    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contry', models.CharField(max_length=30, verbose_name='Страна')),
                ...
                ('actor', models.ManyToManyField(related_name='film_actor', to='movies.Actor', verbose_name='актёры')),
                ...
                ('director', models.ManyToManyField(related_name='film_director', to='movies.Actor', verbose_name='режиссёр')),
